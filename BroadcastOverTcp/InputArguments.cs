namespace BroadcastOverTcp
{
    ...
    public class InputArguments
    {
        ...
        protected readonly Dictionary<string, string> ParsedArguments = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase);
        ...
        {
            this.KeyLeadingPattern = !string.IsNullOrEmpty(keyLeadingPattern) ? keyLeadingPattern : Default_Key_Leading_Pattern;
        ...
        {
            return this.IsKey(key) ? key.Substring(this.KeyLeadingPattern.Length) : key;
        }
        public virtual string GetDecoratedKey(string key)
        {
            return !this.IsKey(key) ? (this.KeyLeadingPattern + key) : key;
        }
